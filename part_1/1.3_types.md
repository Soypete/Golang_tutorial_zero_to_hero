...
There are other variable types that come up quite often when you write go code. Here is a list of basic types: 
-`string`: A statement or sentence. This is denoted by a set of quotes `""` or `''`
