...
When you run the this code you should see the Boolean value printed of `true` or `false`. Since 2 is in fact a larger number than 1, we expect the statement `1 < 2` to be evaluated as `true`. If that is printed below, we win!
